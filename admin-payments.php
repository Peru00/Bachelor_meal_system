...
// Add query to find members who haven't paid this month
$unpaid_members_query = "SELECT u.id, u.first_name, u.last_name, u.balance 
                        FROM users u 
                        WHERE u.role = 'member' 
                        AND NOT EXISTS (
...
<body>
    ...
    <main class="admin-container">
        ...
        <section class="glass-card">
            <h2>Members Without Payment This Month</h2>
            <table class="payments-table">
                <thead>
                    <tr>
                        <th>Member Name</th>
